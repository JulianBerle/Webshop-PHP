...
<body>
    ...
    <div class="items">
        ...
        <?php
            ...
            while($row = $query->fetch()) {
                echo "<div class='item'><span class='teksten'>" . $row['id'] . "<br> Naam: " . $row['name'] . "<br> Prijs: €". $row['price'] . "<br></span><a href='admin-panel.php?delete-item=" . $row['id'] . "' class='buttonDelete' id='item-" . $row['id'] . "'>Delete</a><br></div> <br>\n";
            };
        ?>
    </div>  
    ...
    <div class="users">
        ...
        <?php
            ...
            while($row = $query->fetch()) {
                echo "<div class='item'><span class='teksten'>" . $row['id'] . "<br> Naam: " . $row['username'] . "<br> Password: " . $row['password'] . " <br></span><a href='admin-panel.php?delete-user=" . $row['id'] . "' class='buttonDelete' id='user-" . $row['id'] . "'>Delete</a><br></div> <br>\n";
            };
        ?>
    </div> 
